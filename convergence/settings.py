...
MEDIA_ROOT = os.path.join(BASE_DIR, "static/uploads/media/")

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://example.com/media/", "http://media.example.com/"
MEDIA_URL = '/static/uploads/media/'
...
SECRET_KEY = 'zrfosr849h7j^9(p84$nj$lo!oh$%*=8*0r+-t1wu=#rd3e3=n'
